...
export function buildInvitationEmail({ rencontre, baseUrl, texts = {}, association = {} }) {
  ...
  const ctaButton = (url, label) => `
        <table role="presentation" width="300" cellpadding="0" cellspacing="0" border="0" style="width:300px;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
          <tr>
            <td width="300" height="56" align="center" valign="middle" bgcolor="#C1272D" style="width:300px;height:56px;background-color:#C1272D;text-align:center;vertical-align:middle;font-family:Arial,Helvetica,sans-serif;font-size:18px;font-weight:bold;line-height:56px;mso-line-height-rule:exactly;color:#FFFFFF;text-decoration:none;mso-padding-alt:0;">
              <a class="sbc-cta" href="${esc(url)}" target="_blank" title="Ouvrir l'inscription" style="display:block;width:300px;height:56px;color:#FFFFFF !important;mso-themecolor:background1;font-family:Arial,Helvetica,sans-serif;font-size:18px;font-weight:bold;line-height:56px;mso-line-height-rule:exactly;text-align:center;text-decoration:none !important;text-underline:none;mso-style-priority:99;mso-style-textfill-type:solid;mso-style-textfill-fill-color:#FFFFFF;mso-style-textfill-fill-alpha:100%;"><span style="display:block;width:300px;height:56px;line-height:56px;mso-line-height-rule:exactly;text-align:center;color:#FFFFFF !important;mso-themecolor:background1;text-decoration:none !important;text-underline:none;mso-style-textfill-type:solid;mso-style-textfill-fill-color:#FFFFFF;mso-style-textfill-fill-alpha:100%;"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" style="color:#FFFFFF !important;font-size:18px;line-height:56px;text-decoration:none !important;text-underline:none;"><b>${label}</b></font></span></a>
            </td>
          </tr>
        </table>`;
